...
<%--<div id="wpthemedemobar">
	<div class="wpthemedemobar_wrapper">
		...
		<div class="wptdb_current" >
			<span><img src="images/logo3.png"/ width="170px"></span>
			
			<span id="unLogin" ><a style="font-size: 16px;color:white"
...
.center{margin:0 410px 0 210px; background:#ffe6b8; height:487px;}
	...
	if(isLogin!==''){
		...
		<div  >
			...
			<span id="unLogin" ><a style="font-size: 16px;color:white;margin-left:600px"
					href="javascript:login();">我的博客<span style="color:red;font-size:12px">(登录)</span></a> </span>
